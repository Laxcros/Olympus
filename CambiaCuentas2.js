const DEFAULT_LANG = {
    button: {
        add: "Añadir un personaje"
    },
    msg: {
        error: "Ha surgido un error con el cambio.",
        confirm: "¿Confirmas cambiar el persoanje?"
    },
    modal: {
...
const DEFAULT_OPT = {
    ...
    deleteIcon: `×`,
    addIcon: `+`,
    errorMsg: 'Ha surgido un error con el cambio.',
    confirmMsg: '¿Confirmas cambiar el persoanje?',
    modal: {}
};
